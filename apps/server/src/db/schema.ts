...
/** Default Better Auth owner for existing rows and CLI/sync writes. */
...
export const providerObservations = sqliteTable(
  "provider_observations",
  {
    ...
    userId: text("user_id").notNull().default(ADMIN_USER_ID),
 ...
 */
export const libraryOverrides = sqliteTable(
  "library_overrides",
  {
    userId: text("user_id").notNull().default(ADMIN_USER_ID),
...
export const exportMarks = sqliteTable(
  ...
  (t) => [primaryKey({ columns: [t.userId, t.sink, t.contentKey] })]
);
...
export const watchlist = sqliteTable(
  ...
  (t) => [primaryKey({ columns: [t.userId, t.tmdbType, t.tmdbId] })]
);
